	...
	<main>
		...
		<form class="form-control" method="post" action="<%=request.getContextPath()%>/MecanicaServlet?acao=calcularSplit" id="form">
			...
			<div class="mb-3">
				...
				<input type="radio" id="quantidadeDeSol" aria-describedby="quantidadeDeSol" name="quantidadeDeSol"
				...
				<input type="radio" id="quantidadeDeSol" aria-describedby="quantidadeDeSol" name="quantidadeDeSol" value="não" required="required"
			...
			<div class="mb-3">
				<label for="numeroDePessoas" class="form-label">Numero de pessoas no ambiente</label> 
				<input type="text" class="form-control" id="numeroDePessoas" required="required"
					aria-describedby="numeroDePessoas" name="numeroDePessoas" value="<fmt:formatNumber pattern = "#"  value = "${modelMecanica.numeroDePessoas}" />">
			</div>
			<div class="mb-3">
				<label for="numeroDeEquipamentos" class="form-label">Numero de equipamentos no ambiente</label> 
				<input type="text" class="form-control" id="numeroDeEquipamentos" required="required"
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="btuh" aria-describedby="btuh" name="btuh" 
				value="<fmt:formatNumber pattern = "#"  value = "${modelMecanica.btuh}" />" readonly="readonly">
			</div>
