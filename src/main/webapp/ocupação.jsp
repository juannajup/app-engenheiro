	...
	<main>
		...
		<form class="form-control" method="post" action="<%=request.getContextPath()%>/EletricaServlet?acao=ocupacao" id="form">
			...
			<div class="mb-3">
				...
				<br>
				<input type="radio" id="rede" aria-describedby="rede" name="rede" value="monofasico" required="required" checked>
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="potencia" required="required"
					aria-describedby="potencia" name="potencia" value="${modelEletrica.potencia}">
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				<label for="voltAmper" class="form-label">Volt-Amper (VA)</label> <input
					...
					aria-describedby="voltAmper" readonly="readonly" name="voltAmper" value="${modelEletrica.voltAmper}">
			</div>
			<div class="mb-3">
				<label for="amper" class="form-label">Corrente Calculada (A)</label> 
				<input type="text" class="form-control" id="corrente" aria-describedby="corrente" name="corrente" value="${modelEletrica.corrente}" readonly="readonly">
			</div>
