...
<body>
	...
	<main>
		...
		<h3 id="titulo" class="form-control">Editar Usuario</h3>
		<form class="form-control" method="post"
			action="<%=request.getContextPath()%>/UsuarioServlet?acao=atualizarUsuario"
			id="form">
			<div class="mb-3">
			...
			<div class="mb-3 form-check">
				...
				<input type="radio" id="tipoUsuarioAdmin"
					aria-describedby="tipoUsuario" name="tipoUsuario"
					value="administrador" 
					${usuario.tipoUsuario == 'administrador' ? 'checked="checked"' : ''}>
				<label for="tipoUsuarioAdmin" class="form-label">Administrador</label>

				<input type="radio" id="tipoUsuarioUsuario"
					aria-describedby="tipoUsuario" name="tipoUsuario" value="usuario"
