...
<table border=0 cellpadding=0 cellspacing=0 width=812 style='border-collapse:
 ...
 <tr height=20 style='height:15.0pt'>
  <td colspan=5 height=20 class=xl72 width=812 style='height:15.0pt;width:610pt'><strong>ELETRODUTOS
  DE AÇO-CARBONO (AG)</strong></td>
 </tr>
  ...
  <td class=xl68 width=213 style='border-top:none;border-left:none;width:160pt'>71</td>
		<td class=xl69 width=102
			style='border-top: none; border-left: none; width: 77pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.aco15mm}" />"
  ...
  <td class=xl70 width=213 style='border-top:none;border-left:none;width:160pt'>126</td>
		<td class=xl71 width=102
			style='border-top: none; border-left: none; width: 77pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.aco20mm}" />"
				readonly="readonly"></td>
	</tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl67 width=164 style='height:15.0pt;border-top:none;
  ...
  <td class=xl69 width=102 style='border-top:none;border-left:none;width:77pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.aco25mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl66 width=164 style='height:15.0pt;border-top:none;
  ...
  <td class=xl71 width=102 style='border-top:none;border-left:none;width:77pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.aco32mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl67 width=164 style='height:15.0pt;border-top:none;
  ...
  <td class=xl69 width=102 style='border-top:none;border-left:none;width:77pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.aco40mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl66 width=164 style='height:15.0pt;border-top:none;
  ...
  <td class=xl71 width=102 style='border-top:none;border-left:none;width:77pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.aco50mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl67 width=164 style='height:15.0pt;border-top:none;
  ...
  <td class=xl69 width=102 style='border-top:none;border-left:none;width:77pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.aco65mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl66 width=164 style='height:15.0pt;border-top:none;
  ...
  <td class=xl71 width=102 style='border-top:none;border-left:none;width:77pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.aco80mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl67 width=164 style='height:15.0pt;border-top:none;
  ...
  <td class=xl69 width=102 style='border-top:none;border-left:none;width:77pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.aco100mm}" />"
				readonly="readonly"></td>
 </tr>
</table>