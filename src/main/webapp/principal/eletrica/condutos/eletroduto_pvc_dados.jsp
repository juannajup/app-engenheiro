...
<table border=0 cellpadding=0 cellspacing=0 width=812 style='border-collapse:
 ...
 <tr height=20 style='height:15.0pt'>
  <td colspan=5 height=20 class=xl70 width=812 style='height:15.0pt;width:610pt'><strong>ELETRODUTOS
  DE PVC</strong></td>
 </tr>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=2 class=xl71 width=315 style='border-left:none;width:237pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.pvc20mm}" />"
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=2 class=xl71 width=315 style='border-left:none;width:237pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.pvc25mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl67 width=164 style='height:15.0pt;border-top:none;
  ...
  <td colspan=2 class=xl71 width=315 style='border-left:none;width:237pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.pvc32mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl66 width=164 style='height:15.0pt;border-top:none;
  ...
  <td colspan=2 class=xl71 width=315 style='border-left:none;width:237pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.pvc40mm}" />"
				readonly="readonly"></td>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl67 width=164 style='height:15.0pt;border-top:none;
  ...
  <td colspan=2 class=xl71 width=315 style='border-left:none;width:237pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.pvc50mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl66 width=164 style='height:15.0pt;border-top:none;
  ...
  <td colspan=2 class=xl71 width=315 style='border-left:none;width:237pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.pvc60mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl67 width=164 style='height:15.0pt;border-top:none;
  ...
  <td colspan=2 class=xl71 width=315 style='border-left:none;width:237pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.pvc75mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl66 width=164 style='height:15.0pt;border-top:none;
  ...
  <td colspan=2 class=xl71 width=315 style='border-left:none;width:237pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.pvc85mm}" />"
				readonly="readonly"></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl67 width=164 style='height:15.0pt;border-top:none;
  ...
  <td colspan=2 class=xl71 width=315 style='border-left:none;width:237pt'><input
				...
				value="<fmt:formatNumber pattern = "#.##"  value = "${modelInfraDados.pvc100mm}" />"
				readonly="readonly"></td>
 </tr>
</table>