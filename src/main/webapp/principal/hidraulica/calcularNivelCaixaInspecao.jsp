...
<body>
	...
	<main>
		...
		<h3 id="titulo" class="form-control">Calcular Nivel das Caixas de
			Inspeção</h3>
		<form class="form-control" method="post"
			...
			<div class="mb-3">
				<label for="inclinacaoTubo" class="form-label">Inclinação do
					tubo (%)</label>
				<input type="text" class="form-control" id="inclinacaoTubo"
					required="required" aria-describedby="inclinacaoTubo"
					name="inclinacaoTubo"
					value="${modelHidrossanitario.inclinacaoTubo}">
			</div>

			<div class="mb-3">
				<label for="distanciaCaixas" class="form-label">Distancia
					entre as caixas de inspeção (m)</label>
				<input type="text" class="form-control" id="distanciaCaixas"
					required="required" aria-describedby="distanciaCaixas"
					name="distanciaCaixas"
